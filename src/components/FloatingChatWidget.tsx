...
const FloatingChatWidget = ({ rocketDesign, simulationResults }: FloatingChatWidgetProps) => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hi! I'm your AI rocket coach. Ask me anything about your rocket design!",
      isUser: false,
      timestamp: new Date()
    }
  ]);
...
- Nose: ${rocketDesign.nose.name}
- Body: ${rocketDesign.body.diameter}mm × ${rocketDesign.body.length}mm
- Fins: ${rocketDesign.fins.name}
- Engine: ${rocketDesign.engine.name}
- Total Mass: ${rocketDesign.totalMass.toFixed(1)}g
- Stability: ${rocketDesign.stability.toFixed(1)}` : 'No rocket design available'}
...
- Flight Time: ${simulationResults.flightTime.toFixed(1)}s` : 'No simulation results available'}

Please provide a helpful answer about model rockets and this specific design.`;
          ...
          <CardContent className="flex flex-col h-full p-3">
            ...
            <div className="flex gap-2">
              <Textarea
                ...
                placeholder="Ask about your rocket..."
